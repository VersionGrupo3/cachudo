...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*EL MEJOR BOT*', body: '〔 𝗕𝗹𝗼𝗱𝗶𝗲 𝗕𝗼𝘁 〕', thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/optimus.ventas.bot'}}}}, aa);
